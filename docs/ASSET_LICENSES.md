...
This document records the origin and usage rights for any third-party assets (fonts, images, icons, sounds) shipped in the ithinkaloft website.
...
| :--- | :--- | :--- | :--- | :--- |
| **Space Grotesk** (Font) | Google Fonts | Florian Karsten | SIL Open Font License, 1.1 | Display Typography |
| **Inter** (Font) | Google Fonts | Rasmus Andersson | SIL Open Font License, 1.1 | Body Typography |

*(Template for future additions: Asset / Source / Author / License / Usage)*
